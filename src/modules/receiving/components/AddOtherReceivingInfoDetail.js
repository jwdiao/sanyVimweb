...
class _SelectOtherReceivingItem extends Component {
    ...
    async componentWillMount () {
        ...
        if (this.material && this.material.id) {
            ...
            pmat = _.omit(pmat, ['id'])
            let defaultDataset = {};
            _.keys(pmat).map(k => Object.assign(defaultDataset, {[otherReceivedItemsMap[k]]: pmat[k].label}))
            this.setState({
    ...
    onBtn2Clicked = () => {
        ...
        this.setState({
            ...
            this.props.history.replace('/main/add-receiving', {materials:this.materials});
        })
    }
                        ...
                        onChange={(v)=>{
                            this.setState((prevState) => {
                                return {
                                    ...
                                    dataSet: Object.assign({},prevState.dataSet, {[otherReceivedItemsMap.quantity]:v}),
